...
| 40–50 | Switch to **Passport dashboard**. | "All ten checks passed. That's a real Razorpay test-mode order — this is the honest, working path." |
...
| 60–75 | Switch to **Passport dashboard**. | "The agent got talked into asking for ₹20,000 instead. Checks 1 through 6 still pass — the signatures and the merchant are fine. Check 7, the amount, catches it." |
